...
export function setupCorpusHandlers() {
    ipcMain.handle('corpus:get-graph', async (_event, options) => {
    ...
    ipcMain.handle('corpus:analyze-topics', async (_event, options) => {
    ...
    ipcMain.handle('corpus:get-text-statistics', async (_event, options) => {
