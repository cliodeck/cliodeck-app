...
export function setupHistoryHandlers() {
    ...
    ipcMain.handle('history:get-events', async (_event, sessionId) => {
    ...
    ipcMain.handle('history:get-chat-history', async (_event, sessionId) => {
    ...
    ipcMain.handle('history:get-ai-operations', async (_event, sessionId) => {
    ...
    ipcMain.handle('history:export-report', async (_event, sessionId, format) => {
        ...
        try {
            ...
            const report = hm.exportSessionReport(validatedData.sessionId, validatedData.format);
    ...
    ipcMain.handle('history:search-events', async (_event, filters) => {
