...
export function setupProjectHandlers() {
    ...
    ipcMain.handle('project:remove-recent', (_event, path) => {
    ...
    ipcMain.handle('project:get-metadata', async (_event, path) => {
    ...
    ipcMain.handle('project:load', async (event, path) => {
    ...
    ipcMain.handle('project:get-chapters', async (_event, projectId) => {
    ...
    ipcMain.handle('project:set-bibliography-source', async (_event, data) => {
    ...
    ipcMain.handle('project:set-csl-path', async (_event, data) => {
    ...
    ipcMain.handle('project:get-config', async (_event, projectPath) => {
    ...
    ipcMain.handle('project:update-config', async (_event, projectPath, updates) => {
