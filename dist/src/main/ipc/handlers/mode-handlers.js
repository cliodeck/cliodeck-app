...
export function setupModeHandlers() {
    ...
    ipcMain.handle('mode:get', async (_event, modeId) => {
    ...
    // Set the active mode
    ipcMain.handle('mode:set-active', async (_event, modeId) => {
    ...
    ipcMain.handle('mode:save', async (_event, mode, target) => {
    ...
    ipcMain.handle('mode:delete', async (_event, modeId, source) => {
    ...
    ipcMain.handle('mode:import', async (_event, filePath, target) => {
    ...
    ipcMain.handle('mode:export', async (_event, modeId, outputPath) => {
