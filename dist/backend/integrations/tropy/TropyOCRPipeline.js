...
export class TropyOCRPipeline {
    ...
    async initialize(language = 'fra') {
        ...
        try {
            ...
            throw new Error('Tesseract.js not available. Please install with: npm install tesseract.js');
        }
    }
    /**
     ...
     */
    async performPDFOCR(pdfPath, options) {
        const language = options?.language || 'fra';
     ...
     */
    async importTranscription(config) {
     ...
     */
    parseTranskribusExport(filePath) {
