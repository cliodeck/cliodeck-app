...
export class BibliographyStatsEngine {
     ...
     */
    calculatePublicationsByYear(citations) {
     ...
     */
    calculatePublicationsByType(citations) {
     ...
     */
    calculateAuthorStats(citations) {
     ...
     */
    calculateJournalStats(citations) {
     ...
     */
    calculateTimelineData(citations) {
        const yearMap = new Map();
