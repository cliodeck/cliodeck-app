...
export class OrphanPDFDetector {
     ...
     * @returns Result with success/failure counts
     */
    async archiveOrphans(filePaths, projectPath, archiveSubdir = 'orphan_pdfs') {
     ...
     */
    async scanForPDFs(dirPath, recursive) {
        const pdfFiles = [];
        try {
