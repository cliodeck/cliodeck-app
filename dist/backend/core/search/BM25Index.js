...
export class BM25Index {
    constructor() {
        ...
        this.avgDocLength = 0;
        this.isDirty = true; // Track if cache needs update
    ...
    addChunks(chunks) {
        ...
        console.log(`✅ BM25 index built in ${duration}ms (${Math.round(chunks.length / (duration / 1000))} chunks/s)`);
    }
    /**
     * Search for chunks matching query
     */
    search(query, k = 10, documentIds) {
