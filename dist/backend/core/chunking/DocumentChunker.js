...
export class DocumentChunker {
    ...
    createChunks(pages, documentId, documentMeta) {
        ...
        console.log(`✅ ${chunks.length} chunks créés (config: max=${this.config.maxChunkSize}, overlap=${this.config.overlapSize})`);
        return chunks;
    }
     ...
     */
    createSemanticChunks(pages, documentId) {
        const chunks = [];
        let chunkIndex = 0;
    ...
    static compareConfigs(pages, documentId) {
        const configs = [
