...
export class TextometricsService {
     ...
     */
    calculateFrequencyDistribution(frequency) {
     ...
     */
    analyzeCorpus(documents, topN = 50) {
     ...
     */
    analyzeDocument(documentId, documentText, corpusDocuments, topN = 50) {
     ...
     */
    calculateTfIdf(documentText, corpusDocuments, topN) {
