...
export class ModeManager {
     ...
     */
    async deleteMode(modeId, source) {
     ...
     */
    async importMode(filePath, target) {
     ...
     */
    async exportMode(modeId, outputPath) {
     ...
     */
    static validateModeFile(content) {
        const errors = [];
        let parsed;
        try {
     ...
     */
    async loadModesFromDirectory(dirPath, source) {
