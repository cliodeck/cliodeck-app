...
> Updated: 2026-05-07
> Branch: `feat/fusion-cliobrain` (~75 commits ahead of main, not yet pushed)
...
- Recipe editor (form-based + Monaco YAML)
...
| Document | Purpose |
|---|---|
| `docs/adr/0001-0006` | Architecture Decision Records (RAG, retrieval, MCP, providers, threat model, credentials) |
